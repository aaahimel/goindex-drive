...
function nav(path) {
    ...
    <a href="https://github.com/aaahimel/goindex-drive" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
...
if(search){
    document.write('<script src="//cdn.jsdelivr.net/gh/aaahimel/goindex-drive@2.3/themes/material/cari.js"></script>');
}
